    ...
    <div className='bg-green-900'>
      <Wrapper>
        <div className='text-center mx-auto justify-center text-white py-20'>
          ...
          <h1 className='text-xl  md:w-[820px] pb-5 mx-auto'> Eliminate recruitment time, high payroll, logistics and accommodation costs by outsourcing your workforce</h1>
